...
from ctxwatch.async_migrations.async_migration_utils import (
    complete_migration,
    execute_op,
...
# from khulnasoft.models.instance_setting import get_instance_setting
# from khulnasoft.models.utils import UUIDT
# from khulnasoft.version_requirement import ServiceVersionRequirement
...
def start_async_migration(migration: AsyncMigration, ignore_khulnasoft_version=False) -> bool:
