...
# ALLOWED_HOSTS = [
#     "billing.khulnasoft.com",
#     "billing.dev.khulnasoft.dev",
#     "127.0.0.1",
#     "localhost",
# ]
...
CSRF_TRUSTED_ORIGINS = ["https://*.khulnasoft.dev", "https://*.khulnasoft.com"]
...
if SOCIAL_AUTH_GOOGLE_OAUTH2_KEY:
    ...
    SOCIAL_AUTH_GOOGLE_OAUTH2_WHITELISTED_DOMAINS = ["khulnasoft.com"]
...
if TEST or DEBUG:
    PG_HOST = get_from_env("PGHOST", "localhost")
    PG_USER = get_from_env("PGUSER", "khulnasoft_billing")
    PG_PASSWORD = get_from_env("PGPASSWORD", "khulnasoft_billing")
    PG_PORT = get_from_env("PGPORT", "5433")
    PG_DATABASE = get_from_env("PGDATABASE", "khulnasoft_billing")
else:
    PG_HOST = get_from_env("PGHOST")
    PG_USER = get_from_env("PGUSER")
    PG_PASSWORD = get_from_env("PGPASSWORD")
    PG_PORT = get_from_env("PGPORT")
    PG_DATABASE = get_from_env("PGDATABASE")

DATABASE_URL = get_from_env("DATABASE_URL", f"postgres://{PG_USER}:{PG_PASSWORD}@{PG_HOST}:{PG_PORT}/{PG_DATABASE}")
...
REST_FRAMEWORK = {
    "DEFAULT_AUTHENTICATION_CLASSES": [
        "billing.auth.JwtAuthentication",
...
# DRF Exceptions Hog
# https://github.com/KhulnaSoft/drf-exceptions-hog#readme
EXCEPTIONS_HOG = {
    "EXCEPTION_REPORTING": "billing.utils.exception_reporter",
}
...
KHULNASOFT_PROJECT_API_KEY = get_from_env("KHULNASOFT_PROJECT_API_KEY", "123456789")
