...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "ctxwatch.settings")
...
def run_backup(backup_id: str, incremental: bool = False):
    from ctxwatch.clickhouse import backups
...
def schedule_backups():
    ...
    # instead of waiting for the next deployment or restart of CtxWatch service
    from ctxwatch.models.backup import ScheduledBackup
...
def run_async_migration(migration_name: str):
    from ctxwatch.async_migrations.runner import start_async_migration
    from ctxwatch.models.async_migration import AsyncMigration
